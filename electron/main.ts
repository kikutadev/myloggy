...
import { createMainWindow, createMiniWindow, createTray, broadcastSettingsChanged } from './window-manager.js';
...
app.whenReady().then(() => {
  ...
  registerIpcHandlers(tracker, () => mainWindow, (settings: AppSettings) => broadcastSettingsChanged(settings));
});
